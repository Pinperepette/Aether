...
struct AISettingsTab: View {
    @AppStorage("claudeAPIKeyConfigured") private var apiKeyConfigured = false
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text("Claude AI Security Analysis")
                        .font(.headline)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Label("API key stored in macOS Keychain", systemImage: "lock.shield")
                    .font(.caption)
                Label("Uses your Claude API credits", systemImage: "dollarsign.circle")
                    .font(.caption)
            }
            .foregroundColor(.secondary)
    ...
    private func saveAPIKey() {
        ...
        // Save to Keychain
        let result = KeychainHelper.save(key: "ClaudeAPIKey", value: apiKey)
    ...
    private func loadAPIKey() {
        if let savedKey = KeychainHelper.load(key: "ClaudeAPIKey") {
